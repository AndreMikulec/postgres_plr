...
package() {
  ...
  #
  export ZIP=PLR_${MSYSTEM}_${PLR_TAG_SHORT}_${PLR_GIT_COMMIT}_${PLR_BUILD_CONFIG}_USING_PG_${PG_VERSION_SHORT}_${PG_ACQUIRE_METHOD}_${PG_BUILD_CONFIG}_LINKED_TO_R_${R_OLD_VERSION_SHORT}_CI_BUILD_VERSION_${APPVEYOR_BUILD_VERSION}_${FANCY_BUILD_DAY}.tar.gz
  echo ${ZIP}
  cd ${ZIPTMP}
  loginfo "BEGIN tar CREATION"
  ...
  cp -r    ${PGINSTALL}/share${DIRPOSTGRESQL}/extension/plr*.* ${ZIPTMP}/share
  #
  export ZIP=PLR_${MSYSTEM}_${PLR_TAG_SHORT}_${PLR_GIT_COMMIT}_${PLR_BUILD_CONFIG}_USING_PG_${PG_VERSION_SHORT}_${PG_ACQUIRE_METHOD}_${PG_BUILD_CONFIG}_LINKED_TO_R_${R_CUR_VERSION_SHORT}_CI_BUILD_VERSION_${APPVEYOR_BUILD_VERSION}_${FANCY_BUILD_DAY}.tar.gz
  echo ${ZIP}
  cd ${ZIPTMP}
  loginfo "BEGIN tar CREATION"
  tar -zcvf ${APPVEYOR_BUILD_FOLDER}/${ZIP} *
